...
<section class="bg-white py-10">
    <div class="container mx-auto px-4 max-w-3xl">
        ...
        <form action="{{ route('bbf.register.store') }}" method="POST"
              x-data="{
                step: 1,
        ...
        >
            ...
            <div class="flex mb-6 border-b">
                <template x-for="(tab, index) in steps" :key="index">
                    <button type="button" @click="goToStep(index)"
                            :class="step === index + 1 ? 'border-b-4 border-green text-green font-semibold' : 'text-gray-500 hover:text-green'"
            ...
            <div x-show="step === 1" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="full_name" value="{{ old('full_name') }}" required class="border rounded p-2 w-full">
                </div>
                <div>
                    <label>TSC Number</label>
                    <input type="text" name="tsc_number" value="{{ old('tsc_number') }}" required class="border rounded p-2 w-full">
                </div>
                <div>
                    <label>Phone Number</label>
                    <input type="text" name="phone_number" value="{{ old('phone_number') }}" required class="border rounded p-2 w-full">
                </div>
                <div>
                    <label>Gender</label>
            ...
            <div x-show="step === 2" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="school_name" value="{{ old('school_name') }}" required class="border rounded p-2 w-full">
                </div>
                <div>
                    ...
                    <select name="sub_county_id" required class="border rounded p-2 w-full">
                        ...
                        @foreach($subCounties as $subCounty)
                            <option value="{{ $subCounty->id }}" {{ old('sub_county_id')==$subCounty->id ? 'selected' : '' }}>{{ $subCounty->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    <label>Zone</label>
                    <input type="text" name="zone" value="{{ old('zone') }}" required class="border rounded p-2 w-full">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="year_posting" value="{{ old('year_posting') }}" required class="border rounded p-2 w-full">
                </div>
            </div>
            ...
            <div x-show="step === 3" class="space-y-4">
                ...
                <div>
                    <label>Full Name</label>
                    <input type="text" name="nok_full_name" value="{{ old('nok_full_name') }}" class="border rounded p-2 w-full">
                </div>
                <div>
                    <label>Relationship</label>
                    <input type="text" name="nok_relationship" value="{{ old('nok_relationship') }}" class="border rounded p-2 w-full">
                </div>
                <div>
                    <label>Phone</label>
                    <input type="text" name="nok_phone" value="{{ old('nok_phone') }}" class="border rounded p-2 w-full">
                </div>
            </div>
            ...
            <div x-show="step === 4" class="space-y-4">
                ...
                <div>
                    <label>Name</label>
                    <input type="text" name="father_name" value="{{ old('father_name') }}" class="border rounded p-2 w-full">
                </div>
                <div>
                    <label>Status</label>
                ...
                <div>
                    ...
                    <input type="text" name="father_id" value="{{ old('father_id') }}" class="border rounded p-2 w-full">
                </div>
                ...
                <div>
                    <label>Name</label>
                    <input type="text" name="mother_name" value="{{ old('mother_name') }}" class="border rounded p-2 w-full">
                </div>
                <div>
                    <label>Status</label>
                ...
                <div>
                    <label>National ID</label>
                    <input type="text" name="mother_id" value="{{ old('mother_id') }}" class="border rounded p-2 w-full">
                </div>
                ...
                <template x-for="(spouse, index) in spouses" :key="index">
                    <div class="border p-2 mb-2 rounded relative">
                        ...
                        <div class="mb-2">
                            <label>Full Name</label>
                            <input type="text" :name="'spouses['+index+'][full_name]'" x-model="spouses[index].full_name" class="border rounded p-2 w-full">
                        </div>
                        <div class="mb-2">
                            <label>ID Number</label>
                            <input type="text" :name="'spouses['+index+'][id_number]'" x-model="spouses[index].id_number" class="border rounded p-2 w-full">
                        </div>
                        <div>
                            <label>Phone Number</label>
                            <input type="text" :name="'spouses['+index+'][phone_number]'" x-model="spouses[index].phone_number" class="border rounded p-2 w-full">
                        </div>
                    </div>
                </template>
                <button type="button" @click="addSpouse()" class="px-3 py-1 bg-green text-white rounded mt-2" x-show="spouses.length < maxSpouses">Add Spouse</button>
                ...
                <template x-for="(child, index) in children" :key="index">
                    <div class="border p-2 mb-2 rounded relative">
                        ...
                        <div class="mb-2">
                            <label>Full Name</label>
                            <input type="text" :name="'children['+index+'][full_name]'" x-model="children[index].full_name" class="border rounded p-2 w-full">
                        </div>
                        <div class="mb-2">
                            <label>Date of Birth</label>
                            <input type="date" :name="'children['+index+'][dob]'" x-model="children[index].dob" class="border rounded p-2 w-full">
                        </div>
                        <div>
                            <label>Birth Certificate Number</label>
                            <input type="text" :name="'children['+index+'][birth_cert_no]'" x-model="children[index].birth_cert_no" class="border rounded p-2 w-full">
                        </div>
                    </div>
                </template>
                <button type="button" @click="addChild()" class="px-3 py-1 bg-green text-white rounded mt-2" x-show="children.length < maxChildren">Add Child</button>
            </div>
