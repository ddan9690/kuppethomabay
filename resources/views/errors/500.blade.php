...
<body class="bg-gray-light flex items-center justify-center min-h-screen">
    ...
    <div class="text-center p-6 max-w-md">
        ...
        <h1 class="text-6xl font-bold text-green mb-4">
            500
        </h1>
        ...
        <p class="text-gray mb-6">
            We are experiencing technical challenges at the moment. Please try again shortly.
        </p>

        <a href="/"
           class="inline-block px-6 py-3 bg-green text-white rounded-lg hover:bg-green-dark transition">
            Go Back Home
        </a>
